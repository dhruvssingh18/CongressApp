  ...
  observer.observe(reveal);
    ...
    var myArray = JSON.parse(localStorage.getItem('myArray')) || [
        ...
        {"name": "Mike Johnson", "time_slot": "11:00 AM - 12:00 PM", "job": "Designer", "attended": false},
         {"name": "Alice Carter", "time_slot": "8:30 AM - 9:30 AM", "job": "Engineer", "attended": true},
        {"name": "Brian Lee", "time_slot": "9:45 AM - 10:45 AM", "job": "Product Manager", "attended": false},
        {"name": "Samantha Green", "time_slot": "11:00 AM - 12:00 PM", "job": "UX Designer", "attended": true}
    ];
